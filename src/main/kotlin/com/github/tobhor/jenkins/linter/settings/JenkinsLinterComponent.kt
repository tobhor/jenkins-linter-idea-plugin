...
class JenkinsLinterComponent {
    ...
    private var oAuthTokenCheckbox: JCheckBox = JCheckBox()
    ...
    var isOAuthToken: Boolean
        get() = oAuthTokenCheckbox.isSelected
        set(value) {
            oAuthTokenCheckbox.isSelected = value
        }
    ...
    init {
        panel = FormBuilder.createFormBuilder()
            ...
            .addLabeledComponent(JBLabel("Token is OAuthToken:"), oAuthTokenCheckbox, 1, false)
